...
const
  ...
  RCUTILS_ERROR_STATE_FILE_MAX_LENGTH* = (RCUTILS_ERROR_MESSAGE_MAX_LENGTH -
      ...
      RCUTILS_ERROR_FORMATTING_CHARACTERS - 1) ##  The calculated maximum length for the filename.
                                            ##
...
type
  ...
  rcutils_error_state_t* {.importc: "rcutils_error_state_t",
    ...
    message* {.importc: "message".}: array[768, char] ##  User message storage, limited to RCUTILS_ERROR_STATE_MESSAGE_MAX_LENGTH characters.
