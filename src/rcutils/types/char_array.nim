...
proc rcutils_char_array_strncat*(char_array: ptr rcutils_char_array_t; src: cstring;
                                n: csize_t): rcutils_ret_t {.cdecl,
...
proc rcutils_char_array_strcat*(char_array: ptr rcutils_char_array_t; src: cstring): rcutils_ret_t {.
...
proc rcutils_char_array_memcpy*(char_array: ptr rcutils_char_array_t; src: cstring;
                               n: csize_t): rcutils_ret_t {.cdecl,
...
proc rcutils_char_array_strcpy*(char_array: ptr rcutils_char_array_t; src: cstring): rcutils_ret_t {.
