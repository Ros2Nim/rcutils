...
proc rcutils_string_map_init*(string_map: ptr rcutils_string_map_t;
    ...
    importc: "rcutils_string_map_init", header: "string_map.h".}
...
proc rcutils_string_map_set_no_resize*(string_map: ptr rcutils_string_map_t;
    ...
    importc: "rcutils_string_map_set_no_resize", header: "string_map.h".}

proc rcutils_string_map_unset*(string_map: ptr rcutils_string_map_t; key: cstring): rcutils_ret_t {.
...
proc rcutils_string_map_get*(string_map: ptr rcutils_string_map_t; key: cstring): cstring {.
    importc: "rcutils_string_map_get", header: "string_map.h".}

proc rcutils_string_map_getn*(string_map: ptr rcutils_string_map_t; key: cstring;
                             key_length: csize_t): cstring {.
