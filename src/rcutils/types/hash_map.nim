...
type
  ...
  rcutils_hash_map_impl_t* {.importc: "rcutils_hash_map_impl_t",
    ...
    map* {.importc: "map".}: ptr rcutils_array_list_t ##  This is the array of buckets that will store the keypairs
  ...
  rcutils_hash_map_t* {.importc: "rcutils_hash_map_t", header: "hash_map.h", bycopy.} = object ##
...
proc rcutils_hash_map_string_cmp_func*(val1: pointer; val2: pointer): cint {.cdecl,
    importc: "rcutils_hash_map_string_cmp_func", header: "hash_map.h".}
...
proc rcutils_hash_map_fini*(hash_map: ptr rcutils_hash_map_t): rcutils_ret_t {.cdecl,
...
proc rcutils_hash_map_get_capacity*(hash_map: ptr rcutils_hash_map_t;
                                   capacity: ptr csize_t): rcutils_ret_t {.cdecl,
...
proc rcutils_hash_map_get_size*(hash_map: ptr rcutils_hash_map_t; size: ptr csize_t): rcutils_ret_t {.
