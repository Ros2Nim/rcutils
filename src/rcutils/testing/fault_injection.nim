...
when rcutilsDynlib == "":
  {.pragma: clib, header: "rcutils/fault_injection.h" .}
else:
...
proc rcutils_fault_injection_is_test_complete*(): bool {.cdecl,
    importc: "rcutils_fault_injection_is_test_complete", clib.}

proc rcutils_fault_injection_set_count*(count: int64) {.cdecl,
    importc: "rcutils_fault_injection_set_count", clib.}
  ##
                              ##
...
proc rcutils_fault_injection_get_count*(): int64 {.cdecl,
    importc: "rcutils_fault_injection_get_count", clib.}
  ##
                              ##
...
proc rcutils_fault_injection_maybe_fail*(): int64 {.cdecl,
    importc: "_rcutils_fault_injection_maybe_fail", clib.}
  ##
                              ##
