...
type
  ...
  rcutils_shared_library_t* {.importc: "rcutils_shared_library_t",
    ...
    lib_pointer* {.importc: "lib_pointer".}: pointer ##  The platform-specific pointer to the shared library
...
proc rcutils_is_shared_library_loaded*(lib: ptr rcutils_shared_library_t): bool {.
    cdecl, importc: "rcutils_is_shared_library_loaded", header: "shared_library.h".}
...
proc rcutils_get_platform_library_name*(library_name: cstring;
    ...
    cdecl, importc: "rcutils_get_platform_library_name", header: "shared_library.h".}
